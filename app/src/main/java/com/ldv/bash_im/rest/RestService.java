...
public final class RestService {
    ...
    public List<StoriesModel> get_story (@NonNull String site, //создаем инстанс нашей модели для запроса, третий параметр вынесли в константу
                                          @NonNull String name,
                                          @NonNull int num) throws IOException { //IOEXception - чтоб не было трай кеч
